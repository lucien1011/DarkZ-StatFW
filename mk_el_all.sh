...
outputDir=DataCard/2020-03-03_CutAndCount_m4lSR-HZZd_RunII_El/
...
# ________________________________________________________________________________________________________________________ ||
if ${mkDC} ; then
    python makeDataCard.py --inputDir ${inputDir2016} --verbose --outputDir ${outputDir} --sideband --appendToPath "2016" --systTextFile ${systTextFile2016} --zxShapeDir ${zxShapeDir2016} --interpolPath ${interDir2016} --sigSF=${sigSF} --elOnly 
    python makeDataCard.py --inputDir ${inputDir2017} --verbose --outputDir ${outputDir} --sideband --appendToPath "2017" --systTextFile ${systTextFile2017} --zxShapeDir ${zxShapeDir2017} --interpolPath ${interDir2017} --sigSF=${sigSF} --elOnly 
    python makeDataCard.py --inputDir ${inputDir2018} --verbose --outputDir ${outputDir} --sideband --appendToPath "2018" --systTextFile ${systTextFile2018} --zxShapeDir ${zxShapeDir2018} --interpolPath ${interDir2018} --sigSF=${sigSF} --elOnly 
fi
