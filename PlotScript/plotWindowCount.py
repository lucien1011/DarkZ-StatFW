...
outputDir       = "/home/lucien/public_html/Higgs/DarkZ/WindowCount/RunII/2019-08-14/"
...
for channel in channels:
    c = ROOT.TCanvas()
    channel.histDict = {}
    channel.tstack = ROOT.THStack("stackHist_"+channel.name,";Window index;Event yield/window width")
