...
outputDir=DataCard/2019-07-17_CutAndCount_m4lSR-m4lLowSB-m4lHighSB_HZZd-ppZZd_RunII/
#outputDir=DataCard/2019-07-17_CutAndCount_m4lSR-m4lLowSB-m4lHighSB_HZZd-ppZZd_RunII_EpsPOI/

# ________________________________________________________________________________________________________________________ ||
python makeDataCard.py --inputDir ${inputDir2016} --verbose --outputDir ${outputDir} --sideband --appendToPath "2016" --systTextFile Config/Syst_Run2016.txt,Config/Syst_2mu2e_Run2016.txt --interpolPath ${interDir2016} #--epsilon
python makeDataCard.py --inputDir ${inputDir2017} --verbose --outputDir ${outputDir} --sideband --appendToPath "2017" --systTextFile Config/Syst_Run2017.txt,Config/Syst_2mu2e_Run2017.txt --interpolPath ${interDir2017} #--epsilo}
python makeDataCard.py --inputDir ${inputDir2018} --verbose --outputDir ${outputDir} --sideband --appendToPath "2018" --systTextFile Config/Syst_Run2018.txt,Config/Syst_2mu2e_Run2018.txt --interpolPath ${interDir2018} #--epsilo}
#
## ________________________________________________________________________________________________________________________ ||
